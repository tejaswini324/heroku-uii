...
class Details extends React.Component{
    ...
    componentDidMount (){
        ...
        axios({
            url: `https://tranquil-beach-55843/restaurantdetails/${restaurantId}`,
            method:"GET",
    ...
    handleOrder= () => {
        ...
        axios({
            url: `https://tranquil-beach-55843/menuItems/${restaurantId}`,
            method:"GET",
            Headers:{'Content-Type': 'application/json'}
         }).then(response =>{
    ...
    getData = (data) => {
        return fetch(`https://tranquil-beach-55843/payment`, {
            method: "POST",
            headers: {
